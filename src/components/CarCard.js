  ...
  return (
    <div className="col-lg-4 col-sm-6 mb-3">
      <div className={`${CarCardStyles.carCard} h-100`} onClick={clickToRender}>
        ...
        {props.data.discount && (
          <div className={CarCardStyles.saleIcon}>
            <img src={`/assets/sale-icon.png`} alt="sale icon" />
          </div>
        )}
        <img
          className={`${CarCardStyles.img} card-img-top`}
          src={`../assets/car-pictures/${props.data.make}-${props.data.model}-${props.data.year}.jpg`}
        ...
        <div className="card-body">
          ...
          <p className={CarCardStyles.price}>
            <span>Price: </span>${props.data.price}
          </p>
          <p className={CarCardStyles.year}>
            <span>Year: </span>
            {props.data.year}
          </p>
          <p className={CarCardStyles.miles}>
            <span>Miles: </span>
            {props.data.miles}
          </p>
          <p className={`${CarCardStyles.descShort} card-text`}>
