      ...
      <Carousel className={CarouselStyles.caro_wrapper}>
        {discountedCars.map((disCar) => {
          return (
            <Carousel.Item
              key={disCar.vin}
              className={`${CarouselStyles.carousel_item}`}
            >
              <img
                className={CarouselStyles.carouselImg}
                src={`/assets/car-pictures/${disCar.make}-${disCar.model}-${disCar.year}.jpg`}
                alt={`discounted car ${disCar.make} ${disCar.model}`}
              />
              <Link to={`/details/${disCar.vin}`}>
                ...
                <Carousel.Caption className={CarouselStyles.carousel_info}>
                  ...
                  <span className={CarouselStyles.sale}>
                    Sale!
