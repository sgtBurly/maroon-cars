        ...
        // <div className={styles.navbar} sticky="top">
            <ReactBootstrap.Navbar collapseOnSelect sticky="top" className={`navbar ${styles.navbar}`} expand="sm" variant="light">
                ...
                <div className="d-flex">
                    <ReactBootstrap.Nav.Link className={`${styles.clr} d-sm-none`} as={Link} to="/paymentpage"><i className="fas fa-shopping-cart fa-lg"></i></ReactBootstrap.Nav.Link>
                ...
                <ReactBootstrap.Navbar.Collapse  id="responsive-navbar-nav">
                    <ReactBootstrap.Nav className="ml-auto" >
                        ...
                        <ReactBootstrap.Nav.Link className={`${styles.clr} d-none d-sm-inline-block`} as={Link} to="/paymentpage"><i className="fas fa-shopping-cart fa-lg"></i></ReactBootstrap.Nav.Link>
                    </ReactBootstrap.Nav>
