    ...
    >
      ...
      <div className={`${styles.iconSize} d-flex align-items-center`}>
        <ReactBootstrap.Nav.Link
          className={`${styles.clr} d-md-none`}
          as={Link}
          to="/payment"
        >
        ...
        <ReactBootstrap.Navbar.Toggle
          className={`${styles.border} navbar-light`}
      ...
      <ReactBootstrap.Navbar.Collapse id="responsive-navbar-nav">
        <ReactBootstrap.Nav className="ml-auto align-items-center">
          <span className={styles.homeWrapper}>
            <ReactBootstrap.Nav.Link className={styles.clr} as={Link} to="/">
              Home
            </ReactBootstrap.Nav.Link>
          </span>
          ...
          {loggedInMember.email ? (
            ...
            <span className={styles.registerWrapper}>
              <ReactBootstrap.Nav.Link
                className={styles.clr}
                as={Link}
                to="/membership"
          ...
          <ReactBootstrap.Nav.Link
            className={`${styles.clr} d-none d-md-inline-block`}
            as={Link}
            to="/payment"
          >
            <i className="fas fa-shopping-cart fa-lg">
